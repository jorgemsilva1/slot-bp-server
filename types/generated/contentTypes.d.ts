...
export interface ApiAwardAward extends Schema.CollectionType {
  ...
  attributes: {
    ...
    is_premium_prize: Attribute.Boolean & Attribute.DefaultTo<false>;
...
export interface ApiPlayPlay extends Schema.CollectionType {
  ...
  attributes: {
    won: Attribute.Boolean & Attribute.DefaultTo<false>;
    won_premium: Attribute.Boolean & Attribute.DefaultTo<false>;
    is_bacana: Attribute.Boolean &
      Attribute.Required &
      Attribute.DefaultTo<false>;
    prize_id: Attribute.Integer;
    config_id: Attribute.Integer;
...
export interface ApiPlayerPlayer extends Schema.CollectionType {
  ...
  attributes: {
    ...
    is_bacana: Attribute.Boolean & Attribute.Required;
    plays: Attribute.Relation<
      'api::player.player',
      'oneToMany',
      'api::play.play'
...
export interface ApiSlotSlot extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String;
    theme_id: Attribute.String & Attribute.Required & Attribute.Unique;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
